...
export default function Jumbotron() {
    ...
    return (
        ...
        <div className="content">
            ...
            <p className="subtitle">Scegli tra la nostra gamma di prodotti</p>
            ...
            {compareProducts.length > 0 && (
                ...
                to={
                    ...
                    ? `/products/${compareProducts[0].id}`
                    : `/products/compare/${compareProducts.map(p => p.id).join("-")}`
                }
                >
                <button
                    type="submit"
                    className={compareProducts.length > 0 ? "d-block" : "d-none"}
                >
                    Confronto
                </button>
                </Link>
        ...
        {/* --- waves SVG --- */}
        <svg className="wave opacity-low" viewBox="0 0 400 100" preserveAspectRatio="none">
        ...
        <svg className="wave" viewBox="0 0 400 100" preserveAspectRatio="none">
